...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      {/* HOW TO PLAY Section */}
      <section className="relative z-20 py-16 bg-[#002147] text-white overflow-hidden">
        {/* Fun background elements */}
        <div className="absolute -top-16 -left-16 w-32 h-32 bg-[#bbd665]/10 rounded-full blur-3xl animate-spin-slow"></div>
        <div className="absolute top-1/4 right-0 w-48 h-48 bg-[#bbd665]/10 rounded-full blur-3xl animate-pulse-slow"></div>
        <div className="absolute bottom-0 left-1/4 w-40 h-40 bg-[#bbd665]/10 rounded-full blur-3xl animate-bounce-slow"></div>
        <div className="absolute top-1/3 left-2/3 w-20 h-20 bg-white/5 rounded-full blur-lg animate-spin-slow"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border-2 border-[#bbd665]/30 transition-all duration-300 shadow-[0_10px_0_rgba(0,0,0,0.2)] hover:shadow-[0_14px_0_rgba(187,214,101,0.3)] hover:-translate-y-1 group relative overflow-hidden">
              {/* Number badge */}
              <div className="absolute -top-3 -right-3 w-12 h-12 bg-[#bbd665] rounded-full flex items-center justify-center text-[#002147] font-bold text-xl shadow-lg transform rotate-12 transition-transform group-hover:rotate-0">1</div>
              
              <div className="flex flex-col items-center text-center">
                <div className="w-20 h-20 bg-[#bbd665]/20 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border-2 border-[#bbd665]/30 transition-all duration-300 shadow-[0_10px_0_rgba(0,0,0,0.2)] hover:shadow-[0_14px_0_rgba(187,214,101,0.3)] hover:-translate-y-1 group relative overflow-hidden">
              {/* Number badge */}
              <div className="absolute -top-3 -right-3 w-12 h-12 bg-[#bbd665] rounded-full flex items-center justify-center text-[#002147] font-bold text-xl shadow-lg transform rotate-12 transition-transform group-hover:rotate-0">2</div>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border-2 border-[#bbd665]/30 transition-all duration-300 shadow-[0_10px_0_rgba(0,0,0,0.2)] hover:shadow-[0_14px_0_rgba(187,214,101,0.3)] hover:-translate-y-1 group relative overflow-hidden">
              {/* Number badge */}
              <div className="absolute -top-3 -right-3 w-12 h-12 bg-[#bbd665] rounded-full flex items-center justify-center text-[#002147] font-bold text-xl shadow-lg transform rotate-12 transition-transform group-hover:rotate-0">3</div>
              
              <div className="flex flex-col items-center text-center">
                <div className="w-20 h-20 bg-[#bbd665]/20 rounded-full flex items-center justify-center mb-6 group-hover:scale-110 transition-transform animate-pulse-slow">
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-[#bbd665]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
