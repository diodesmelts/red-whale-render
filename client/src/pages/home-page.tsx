...
export default function HomePage() {
  ...
  return (
    <div>
      ...
      {/* HOW TO PLAY Section */}
      <section className="relative z-20 py-16 bg-[#bbd665] text-black overflow-hidden">
        {/* Fun background elements */}
        <div className="absolute -top-16 -left-16 w-32 h-32 bg-white/10 rounded-full blur-3xl"></div>
        <div className="absolute top-1/4 right-0 w-48 h-48 bg-white/10 rounded-full blur-3xl"></div>
        <div className="absolute bottom-0 left-1/4 w-40 h-40 bg-white/10 rounded-full blur-3xl"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12">
            ...
            <p className="text-black/80 max-w-2xl mx-auto mb-6 text-lg">
              Just <span className="text-white font-medium">three simple steps</span> to start winning amazing prizes!
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="bg-white rounded-xl p-8 border-2 border-black/10 transition-all duration-300 shadow-[0_10px_0_rgba(0,0,0,0.1)] hover:shadow-[0_14px_0_rgba(0,0,0,0.1)] hover:-translate-y-1 group relative overflow-hidden">
              {/* Number badge */}
              <div className="absolute -top-3 -right-3 w-12 h-12 bg-black rounded-full flex items-center justify-center text-white font-bold text-xl shadow-lg transform rotate-12 transition-transform group-hover:rotate-0">1</div>
            ...
            <div className="bg-white rounded-xl p-8 border-2 border-black/10 transition-all duration-300 shadow-[0_10px_0_rgba(0,0,0,0.1)] hover:shadow-[0_14px_0_rgba(0,0,0,0.1)] hover:-translate-y-1 group relative overflow-hidden">
              {/* Number badge */}
              <div className="absolute -top-3 -right-3 w-12 h-12 bg-black rounded-full flex items-center justify-center text-white font-bold text-xl shadow-lg transform rotate-12 transition-transform group-hover:rotate-0">3</div>
